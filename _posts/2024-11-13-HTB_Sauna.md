---
title: 'Sauna Walkthrough: From AS-REP Roasting to Domain Admin with DCSync Abuse - HTB'
...
Using the cracked credentials, logged into the machine with **Evil-WinRM** gain an interactive PowerShell session:
